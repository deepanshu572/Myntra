...
const CheckoutCartBox = (item) => {
  ...
  const handleIncrement = (id, size) => {
    dispatch(getIncrement({ id, size }));
  };
  const handleDecrement = (id, size) => {
    dispatch(getDecrement({ id, size }));
  };
  ...
  return (
    <div className="cart_item_data">
      ...
      <div className="cart_item_data_txt">
        <h4>{item.cat_nm}</h4>
        <h5>{item.product_nm}</h5>
        <small>Sold by: {item.product_cm}</small>
        <div className="cart_item_select">
          ...
          <div className="select_box">
            ...
            <div className="select_box_middle">{item.quantity}</div>
        ...
        <div class="return_txt">
          ...
          <span class="returnPeriod-base-returnDays">
