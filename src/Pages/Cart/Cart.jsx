          ...
          <div className="cart_page_left">
            ...
            <div className="cart_page_top_two">
              ...
              <div className="head_p_cart">
                <span>
                  • 10% Instant Discount on Axis Bank Credit Cards, Flipkart
                  Axis Bank Credit Card & Axis Bank Credit Card EMI on a min
                  spend of ₹3,500. TCA
                </span>
              </div>
              <div className={`head_toggle_div ${Toggle ? "show" : "hide"}`}>
                <span>
                  {" "}
                  • 10% Instant Discount on ICICI Bank Credit Cards & Debit
                  Cards on a min spend of ₹3,500. TCA
                </span>
                <span>
                  {" "}
                  • 10% Instant Discount on ICICI Bank Netbanking on a min spend
                  of ₹3,000. TCA
                </span>
                <span>
                  {" "}
                  • 10% Instant Discount on Kotak Bank Credit Cards & Credit
                  Card EMI on a min spend of ₹3,500. TCA
                </span>
                <span>
                  {" "}
                  • 10% Instant Discount on IDFC FIRST SWYP Credit Card on a min
                  spend of ₹850 (Applicable only on Myntra FWD offer Products).
                  TCA
                </span>
                <span>
                  {" "}
                ...
                <span>
                  {" "}
                  • Assured Flat ₹20 Cashbackon Paytm UPI transaction on a min
                  spend of ₹750. TCA
                </span>
                <span>
                  {" "}
                  • Flat ₹40 Cashback on BAJAJ UPI Transactions on a min spend
                  of ₹999. TCA
                </span>
                <span>
                  {" "}
                ...
                <span>
                  {" "}
                  • Get ₹50-₹500 Assured Cashback on minimum transaction of
                  ₹1000 on RuPay Credit Card with Paytm UPI. TCA
                </span>
                <span>
                  {" "}
                  • Get up to ₹399 Cashback on CRED UPI on a min spend of ₹500.
                  TCA
                </span>
                <span>
                  {" "}
                ...
                <span>
                  {" "}
                  • Get Assured ₹30 Cashback on Freecharge UPI on a minimum
                  spend of ₹1,999. TCA
                </span>
                <span>
                  {" "}
                  • Get Upto ₹500 cashback On Mobikwik Wallet transaction on a
                  min spend of ₹1,500.TCA
                </span>
                <span>
                  {" "}
                  • Get up to ₹250 Cashback on Mobikwik UPI on a min spend of
                  ₹999. TCA
                </span>
                <span>
                  {" "}
